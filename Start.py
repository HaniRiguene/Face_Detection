...
label_0 = Label(root, text="Face Identification System",width=50,font=("bold", 20),anchor=CENTER,bg="#386184",fg="white")
label_0.place(x=0,y=100)

Button(root, text='REGISTER Human',width=35,height=3,bg='blue',fg='white',font=("bold", 11),command=register).place(x=250,y=180)
